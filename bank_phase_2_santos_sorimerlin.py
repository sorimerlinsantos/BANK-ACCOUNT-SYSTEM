...
# This block of code is asking the user for the starting balance.
while True:
    ask= input("Do you want to create an account? ")
    if ask == "Yes" or "yes":
        else:
            breakpoint
    ...
    try:
        ...
        continue
    #This continue is giving the user another chance for entering a new number. 
...
# This is the total of what the user is investing because is calculating the money available of the user and the 
...
# This is the conditionals of what is going to get printed if the user chooses any of the investments.
...
print(f"Share price: ${in_share:.2f}")
print(f"Investment amount: ${shares * in_share:.2f}") # The amount of shares with the prices is going to give us the total investment amount.
print(f"Remaining account balance: ${inbalance:.2f}\n")
...
# If we have shares we print the share options.
        ...
        # if the user chooses "2" the withdraw funds menu is going to be printed.
                ...
                try:
                    ...
                    print("Transaction failed: Invalid withdrawal amount.")
                    continue
                # This rule is stating that if we have a period (".") which is a decimal, and answer is not equal to two decimals the input is invalid.
                if "." in answer and answer != f"{w:.2f}":
                    print("Transaction failed: Invalid withdrawal amount.")
                    continue
    ...
    # View balance
        ...
        # If they choose "4" we are closing the account.
            ...
            if shares > 0:
                ...
                inv_value = f"{inv_value * 100:.2f}"
           

                print(f"Investment name: {inv_name}")
                print(f"Shares sold: {shares}")
                print(f"Initial Share Price: ${in_share:.2f}")
                print(f"Current Share Price: ${curr_share_price:.2f}")
                print(f"Investment value: ${curr_share_price * shares:.2f} ({add}{inv_value}%)")
                print(f"Previous account balance: ${balance:.2f}")
                ...
                shares = 0
                print(f"New account balance: ${balance:.2f}")
            ...
            if inv_name != "COLEGIO":
                print(f"COLEGIO\t${investments.get_share_price('COLEGIO'):.2f}")
            if inv_name != "MSFT":
                print(f"MSFT\t${investments.get_share_price('MSFT'):.2f}")
            if inv_name != "GOOG":
                print(f"GOOG\t${investments.get_share_price('GOOG'):.2f}")
